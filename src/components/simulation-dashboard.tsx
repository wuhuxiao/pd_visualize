  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[1680px] flex-col gap-4 px-4 py-6 lg:px-6">
        ...
        <div className="mt-3 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-2 text-sm text-slate-200">
              Virtual time advances only through scheduled events. The UI simply
              renders engine snapshots, so queuing, dispatch, streaming, metrics,
              batching, and saved templates stay reproducible and traceable.
            </p>
          </div>
          <div className="rounded-xl border border-white/15 bg-white/10 px-4 py-3 text-sm">
            <p className="text-sky-100">Default topology</p>
      ...
      <div className="grid gap-4 xl:grid-cols-[320px_minmax(0,1fr)_360px]">
        <TopologyPanel snapshot={snapshot} />
        <TimelinePanel
          snapshot={snapshot}
